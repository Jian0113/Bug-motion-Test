...
import ambiguityDetail from "@/data/noteAmbiguityDetail";

export default function NoteAmbiguityDetail() {
  const { categoryNumber, categoryTitle, categorySubtitle, headline, descriptionLines, cards } = ambiguityDetail;
...
function LeftPanel({ number, title, subtitle, headline, descriptionLines }) {
  ...
  return (
    <div style={{ paddingRight: 10 }}>
      ...
      <div style={{ height: 24 }} />
      <div style={{ ...labelStyle, fontWeight: 600 }}>명확성</div>
    </div>
  );
}
